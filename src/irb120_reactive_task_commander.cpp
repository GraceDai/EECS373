...
int main(int argc, char** argv) {
    ...
    nsteps = 5; //arbitrary; tune merosrun irb120_task_commander.cpp irb120_task_commander.cpp
...
//YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY DECLARED GOAL PLACEMENTS HERE
    float goal_x = 0.5;
    float goal_y = 0.0;
    float shift_x = goal_x - g_perceived_object_pose.pose.position.x; //this was to determine how much to shift x to goal position
    float shift_y = goal_y - g_perceived_object_pose.pose.position.y; //this was to determine how much to shift y to goal position
//YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY

    flange_origin <<g_perceived_object_pose.pose.position.x, g_perceived_object_pose.pose.position.y, 0.0059; 
...
//YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY   THE CODE I ADDED   YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY 
    //shift the gear over to goal pose
    flange_origin <<g_perceived_object_pose.pose.position.x + shift_x, g_perceived_object_pose.pose.position.y + shift_y, 0.002; 
    goal_flange_affine.translation() = flange_origin;
    ROS_INFO_STREAM("move to flange origin= " << goal_flange_affine.translation().transpose() << endl);
